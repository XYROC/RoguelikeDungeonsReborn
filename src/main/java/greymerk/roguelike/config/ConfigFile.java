...
public class ConfigFile extends ConfigurationProvider {
	 ...
	 *
	 * \param [in] filename The name of the file to read. \param [in] parser A
	 * ConfigurationParser which will be used to parse the data in the given file.
	 */
	...
	/**
	 * Writes configurations back to the file from which they were originally drawn,
	 * according to the strategy used to parse them.
	 */
