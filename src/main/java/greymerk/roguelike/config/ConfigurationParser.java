 ...
 *
 * Configuration parsers process raw strings from a configuration source, and
 * transform it into a set of key/value pairs.
 *
 * Configuration parsers process configuration data, and transform it back into
 * the raw strings from which it may be reparsed.
 */
public interface ConfigurationParser {
	 ...
	 *
	 * \param [in] writer A writer which writes to the destination. \param [in]
