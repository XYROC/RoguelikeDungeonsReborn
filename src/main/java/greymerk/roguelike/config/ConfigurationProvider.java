...
public abstract class ConfigurationProvider implements Iterable<Configuration> {
	 ...
	 *
	 * \return \em true if \em key has associated data in the configuration store,
	 * \em false otherwise.
	 */
	 ...
	 *
	 * \param [in] key The key whose associated configuration information is to be
	 * retrieved.
	 *
	...
	/**
	 * Gets a configuration setting, returning some default value if no default is
	 * specified.
	 *
	 * \param [in] key The key whose associated configuration information is to be
	 * retrieved. \param [in] fallback A value which shall be retrieved if no
	 * configuration is associated with \em key.
	 *
	 * \return The data associated with \em key, if it exists, otherwise \em
	 * fallback.
	 */
	 ...
	 *
	 * \param [in] key The key whose associated configuration information is to be
	 * retrieved. \param [in] fallback The value which will be retrieved if \em key
	 * is not present, or if \em key could not be parsed to a double.
	 *
	 ...
	 * \param [in] key The key whose associated configuration information is to be
	 * retrieved. \param [in] fallback The value which will be retrieved if \em key
	 * is not present, or if \em key could not be parsed to an integer.
	 *
	 * \return Either the configuration associated with \em key, or \em fallback.
	 */
	...
	/**
	 * Sets a configuration, creating it if it does not exist, updating it
	 * otherwise.
	 *
	 * \param [in] key The key associated with the configuration to update or
	 * create. \param [in] value The value to associate with \em key.
	 */
	...
	/**
	 * Fetches an iterator which may be used to traverse the configurations in this
